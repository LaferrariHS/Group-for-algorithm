...
PLUGINLIB_EXPORT_CLASS(dijkstra_plugin::DijkstraPlanner, nav_core::BaseGlobalPlanner)
...
**/
DijkstraPlanner::DijkstraPlanner(ros::NodeHandle &nh)
{
  ROSNodeHandle = nh;
}
...
void DijkstraPlanner::initialize(std::string name, costmap_2d::Costmap2DROS *costmap_ros)
{
  ...
  if (!initialized_)
  {
    ...
    ROS_INFO("Dijkstra planner initialized.");
    initialized_ = true;
  }
  else
                            ...
                            std::vector<geometry_msgs::PoseStamped> &plan)
{
  ...
  if (isStartAndGoalValid(startGridSquare, goalGridSquare))
  {
    ...
    bestPath = runDijkstraOnGrid(startGridSquare, goalGridSquare);
...
**/
void DijkstraPlanner::convertToMapCoordinates(float &x, float &y)
{
...
**/
int DijkstraPlanner::getGridSquareIndex(float x, float y)
{
...
**/
bool DijkstraPlanner::isCoordinateInBounds(float x, float y)
{
  bool valid = true;
...
**/
vector<int> DijkstraPlanner::runDijkstraOnGrid(int startGridSquare, int goalGridSquare)
{
...
**/
vector<int> DijkstraPlanner::findPath(int startGridSquare, int goalGridSquare, float g_score[])
{
  value++;
  vector<int> bestPath;
...
**/
vector<int> DijkstraPlanner::constructPath(int startGridSquare, int goalGridSquare, float g_score[])
{
  vector<int> bestPath;
  vector<int> path;
...
**/
void DijkstraPlanner::addNeighborGridSquareToOpenList(multiset<GridSquare> &openSquaresList, int neighborGridSquare, int goalGridSquare, float g_score[])
{
  GridSquare gridSq;
  gridSq.currentGridSquare = neighborGridSquare;
  
  // 不再计算fCost，只考虑g_score
  openSquaresList.insert(gridSq);
}
...
vector<int> DijkstraPlanner::findFreeNeighborGridSquare(int gridSquare)
{
...
**/
bool DijkstraPlanner::isStartAndGoalValid(int startGridSquare, int goalGridSquare)
{
  bool isvalid = true;
...
**/
float DijkstraPlanner::getMoveCost(int i1, int j1, int i2, int j2)
{
...
**/
float DijkstraPlanner::getMoveCost(int gridSquareIndex1, int gridSquareIndex2)
{
...
**/
int DijkstraPlanner::calculateGridSquareIndex(int i, int j) 
{
  return (i * width) + j;
}
...
**/
int DijkstraPlanner::getGridSquareRowIndex(int index) //get the row index from gridSquare index
{
  return index / width;
}
...
**/
int DijkstraPlanner::getGridSquareColIndex(int index) //get column index from gridSquare index
{
  return index % width;
}
...
**/
bool DijkstraPlanner::isFree(int i, int j)
{
...
**/
bool DijkstraPlanner::isFree(int gridSquareIndex)
{
  return occupancyGridMap[gridSquareIndex];
}
};
